...
<body>
    ...
    <header class="d-flex p-3">
        <ul class="nav nav-pills">
            <li class="nav-item"><a href="./home.php" class="nav-link active hover-zoom" aria-current="page">Home</a>
            </li>
    ...
    <div class="container col-xxl-8 px-4 py-5">
        <div class="row flex-lg-row align-items-center g-5 py-5">
            <div class="col-10 col-sm-8 col-lg-6">
                <img src="./images/profile.jpg" class="d-block mx-lg-auto profile-picture" alt="Bootstrap Themes"
                    width="700" height="500" loading="lazy">
            </div>

            <div class="col-lg-6">
                <h1 class="display-5 fw-bold text-body-emphasis lh-1 mb-3">Hi, I'm Zikar!</h1>
                <p class="lead">Aspiring software engineer</p>
                <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                    <button type="button" class="btn btn-primary btn-lg px-4 me-md-2 hover-zoom"><a
                            href="./about.html">About me</a></button>
                </div>
            </div>
        </div>
    </div>
