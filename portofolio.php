...
<body>
    ...
    while ($row = mysqli_fetch_array($res)) {
        ...
        $project_description[] = $row["descript"];
        $img_source[] = $row["img"];
    }
    ...
    <section id="projects">
        <div class="container px-4 py-5" id="custom-cards">
            <h2 class="pb-2 text-heading border-bottom border-secondary">
                Projects
            </h2>

            <div class="cols-lg-3 align-items-stretch g-4 py-5">
                <div class="col py-4">
                    <a href="https://github.com/zizky13/Regrant" class="text-decoration-none">
                        <div class="card card-cover h-100 overflow-hidden text-bg-theme rounded-4 shadow-lg hover-zoom">
                            <img src=<?php echo $img_source[0] ?> alt="regrant">
                            </img>
                            <div class="card-img-overlay d-flex flex-column h-100 p-0 text-white text-shadow-1">
                                <h3
                                    class="display-5 lh-1 fw-bold text-heading text-start text-bg-theme py-3 px-5 projects-link">
                                    <?php echo $project_name[0]; ?>
                                </h3>
                            </div>
                            <h2 class="text-detail p-3 word-wrap"><?php echo $project_description[0] ?></h2>
                        </div>
                    </a>
                </div>
                ...
                <div class="col py-4">
                    <a href="https://github.com/zizky13/WaterWise" class="text-decoration-none">
                        <div class="card card-cover h-100 overflow-hidden text-bg-theme rounded-4 shadow-lg hover-zoom">
                            <img src=<?php echo $img_source[1] ?> alt="regrant">
                            </img>
                            <div class="card-img-overlay d-flex flex-column h-100 p-0 text-white text-shadow-1">
                                <h3
                                    class="display-5 lh-1 fw-bold text-heading text-start text-bg-theme py-3 px-5 projects-link">
                                    <?php echo $project_name[1]; ?>
                                </h3>
                            </div>
                            <h2 class="text-detail p-3 word-wrap"><?php echo $project_description[0] ?></h2>
                        </div>
